...
illuminant=illuS*normpdf([1:331],60,4)+illuM*normpdf([1:331],140,4)+illuL*normpdf([1:331],240,4);
...
color_labels = {'N 5.75/', '5YR 5/6', '5Y 8.5/10', '2.5BG 6/6', '7.5GY 6/6', '5R 5/12', '10RP 6/10', '2.5PB 6/8', '5GY 8.5/8', '10RP 3/6', 'N9.6/', 'N1.25/', '2.5YR 7/10', '5Y 7/8', '2.5B 8/4', 'N6.75/', '5P 7/6', '2.5G 7/6'};
...
% P(5:6, 3:6, :)=P(5:6, 3:6, :).*get_lms(illuminant, color_labels(12));
