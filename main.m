...
color_labels = {'10PB 6/1', '5YR 5/6', '5Y 8.5/10', '2.5BG 6/6', '7.5GY 6/6', '5R 5/12', '10RP 6/10', '2.5PB 6/8', '5GY 8.5/8', '10RP 3/6', '10PB 9/1', '10PB 2.5/1', '2.5YR 7/10', '5Y 7/8', '2.5B 8/4', '10PB 7/1', '5P 7/6', '2.5G 7/6'};
...
P(5:6, 1:2, :)=P(5:6, 1:2, :)+get_lms(illuminant, color_labels(11));  % It must be N 9.6/0 but it is missing in the table, so I took 10PB 9/1
P(5:6, 3:6, :)=P(5:6, 3:6, :)+get_lms(illuminant, color_labels(12));  % It must be N 1.25/0 but it is missing in the table, so I took 10PB 2.5/1
...
P(7:8, 8, :)=P(7:8, 8, :)+get_lms(illuminant, color_labels(16));  % It must be N 6.75/0 but it is missing in the table, so I took 10PB 7/1
...
P = colorspace('CAT02 LMS->RGB', P);

% From pattern to true image
I = zeros(300, 300, 3);
I = colorspace('CAT02 LMS->RGB', I+get_lms(illuminant, color_labels(1)));  % almost gray surround (10PB 6/1 instead of N 5.75/)
